...
(cl:in-package theconstruct_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RLExperimentInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RLExperimentInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name theconstruct_msgs-msg:<RLExperimentInfo> is deprecated: use theconstruct_msgs-msg:RLExperimentInfo instead.")))

(cl:ensure-generic-function 'episode_number-val :lambda-list '(m))
(cl:defmethod episode_number-val ((m <RLExperimentInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader theconstruct_msgs-msg:episode_number-val is deprecated.  Use theconstruct_msgs-msg:episode_number instead.")
  (episode_number m))

(cl:ensure-generic-function 'episode_reward-val :lambda-list '(m))
(cl:defmethod episode_reward-val ((m <RLExperimentInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader theconstruct_msgs-msg:episode_reward-val is deprecated.  Use theconstruct_msgs-msg:episode_reward instead.")
  (episode_reward m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RLExperimentInfo>)))
  ...
  "theconstruct_msgs/RLExperimentInfo")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RLExperimentInfo)))
  "Returns string type for a message object of type 'RLExperimentInfo"
  "theconstruct_msgs/RLExperimentInfo")
