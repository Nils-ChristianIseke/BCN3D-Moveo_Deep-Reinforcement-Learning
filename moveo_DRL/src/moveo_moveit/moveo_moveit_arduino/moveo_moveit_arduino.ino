...
void arm_cb2(const sensor_msgs::JointState& arm_steps){
  joint_status = 1;
  joint_step[0] = arm_steps.position[1];
  joint_step[1] = arm_steps.position[2];
  joint_step[2] = arm_steps.position[3];
  joint_step[3] = arm_steps.position[4];
  joint_step[4] = arm_steps.position[5];
...
void setup() {
  ...
  joint1.setMaxSpeed(62);
  joint2.setMaxSpeed(62);
